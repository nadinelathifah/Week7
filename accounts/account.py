class Account:
    def __init__(self, account_holder, balance):
        self.account_holder_name = account_holder.get_fullname()
        self.__balance = balance

    def deposit(self, amount):
        if amount > 0:
            self.__balance += amount
            return f"\033[92m${amount} has been deposited to the account belonging to {self.account_holder_name}.\033[0m\nNew balance: $\033[97m{self.__balance}\033[0m"
        else:
    ...
    def withdraw(self, amount):
        if 0 < amount < self.__balance:
            self.__balance -= amount
            return f"\033[93m${amount} has been withdrawn from the account belonging to {self.account_holder_name}.\033[0m\nNew balance: $\033[97m{self.__balance}\033[0m"
        else:
